...
class Report_issue extends Admin_Controller
{
    /*
 * @author Yunaz
 ...
 */
    ...
    protected $viewPermission   = 'Report_issue.View';
    protected $addPermission    = 'Report_issue.Add';
    protected $managePermission = 'Report_issue.Manage';
    protected $deletePermission = 'Report_issue.Delete';

    public function __construct()
    {
        parent::__construct();

        $this->load->model('report_issue/report_issue_model');
    ...
    public function index()
    {
        ...
        $clients = $this->report_issue_model->get_user_clients($user_id);
        ...
        $this->template->title('Report Issue');
        $this->template->page_icon('ti ti-lock-access');
    ...
    public function print_weekly_report()
    {
        ...
        $daily_data        = $this->report_issue_model->get_daily_data($client_id, $date_from, $date_to);
        $open_extended     = $this->report_issue_model->get_open_data_extended($client_id, $date_from, $date_to);
        $total_tickets     = $this->report_issue_model->get_total_tickets($client_id, $date_from, $date_to);
        $all_tickets       = $this->report_issue_model->get_tickets_by_date_range($client_id, $date_from, $date_to);
        $open_carry_over   = $this->report_issue_model->get_open_tickets_extended($client_id, $date_from, $date_to);
    ...
    {
        $user_id = $this->auth->user_id();
        $priorities = $this->report_issue_model->get_my_priorities($user_id);
